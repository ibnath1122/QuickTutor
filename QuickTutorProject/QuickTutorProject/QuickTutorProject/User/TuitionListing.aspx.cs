    ...
    public partial class TuitionListing : System.Web.UI.Page
    {
        ...
        protected void lbFilter_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ddlDivision.SelectedValue != "0")
                {
                    queryList.Add(" Country ='" + ddlDivision.SelectedValue + "' ");
                    isCondition = true;
                }
                ...
                if (tutoringMethod != "")
                {
                    queryList.Add(" TutoringMethod IN (" + tutoringMethod + ") ");
                    isCondition = true;
                }
                if (RadioButtonList1.SelectedValue != "0")
                {
                ...
                if (isCondition)
                {
                    ...
                    query = @"Select TuitionId,Title,Subject,Salary,TutoringMethod,StuName,Division,CreateDate from Tuition where " + subquery + " ";
                }
                else
                {
                    query = @"Select TuitionId,Title,Subject,Salary,TutoringMethod,StuName,Division,CreatedDate from Tuition";
                }
